...
namespace Interface_2_Console
{
    ...
    {                                           // 파일출력은 파일을 생성하고 콘솔에 입력된 값을 읽어서 파일로 출력하는것이 필요
        ...
        private StreamWriter writer;            // 파일에 텍스트를 출력해주는 writer 생성(StreamWriter 클래스)
        ...
        public void WriteLog(string message)    // 파일에 입력값을 저장(인터페이스에 맞게)
        {
    ...
    class MainApp
    {
        ...
        {
            ClimateMonitor monitor = new ClimateMonitor(new ConsoleLoger());
